/*
  # Complete Database Reset and Configuration
  ...
  1. New Tables
    ...
    - `image_generations`
      ...
      - `image_type` (text, blog/infographic)
      - `title` (text, optional)
  ...
  2. Security
    ...
    - Add policies for admins to access all data (without recursion)
...
RETURNS TRIGGER AS $$
BEGIN
  -- Check if this is the first user (count before insert)
