...
interface AuthModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSignInWithEmail: (email: string, password: string) => Promise<{ success: boolean; error?: string; message?: string }>;
  ...
  const handleEmailSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.error || result.message || 'Failed to sign in. Please try again.');
      }
    } catch (err: any) {
      if (err.message.includes('Please confirm your email address to sign in.')) {
        setError('Please check your email and click on the verification link to get verified and then sign in.');
      } else {
